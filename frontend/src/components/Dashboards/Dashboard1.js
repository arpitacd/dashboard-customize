...
import dashboardCodes from "./dashboardCode";
...
const Dashboard1 = ({
  ...
  const exportCode = () => {
      let code = dashboardCodes.dashboard1.code({selFontFam,
        selFontsiz,
        selbgcolor,
        selBordercolor,
        selpadding,
        ...
        selFontcolor});
        console.log(code);
      download('dashboardCode.js', code);
  }
    ...
    <div>
      ...
      >
        ...
        <div className="pagetitle" >
          <h1 style={{ fontFamily: selFontFam , color:selFontcolor, fontSize: selFontsiz , borderColor: selBordercolor ,borderWidth: selBorderwid}}>
            Dashboard
          </h1>
          <nav>
            ...
            <div className="col-lg-8">
              <div className="row">
                ...
                <div className="col-xxl-4 col-md-6">
                  <div className="card info-card sales-card" style={{borderRadius : selBorderrad ,borderColor: selBordercolor,borderWidth: selBorderwid, borderStyle: 'solid' }}>
                    ...
                    <div
                      className="card-body"
                      style={{ borderRadius: selBorderrad ,borderColor: selBordercolor ,borderWidth: selBorderwid,}}
                    >
                      <h5 className="card-title" style={{fontFamily: selFontFam , fontSize: selFontsiz, color:selFontcolor,}}>
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ps-3">
                          <h6 style={{ fontFamily: selFontFam }}>145</h6>
                          <span
                            className="text-success small pt-1 fw-bold"
                            style={{ fontFamily: selFontFam , fontSize: selFontsiz}}
                          >
                            12%
                          </span>{" "}
                ...
                <div className="col-xxl-4 col-md-6">
                  <div className="card info-card revenue-card"  style={{ borderRadius: selBorderrad ,borderColor: selBordercolor,borderWidth: selBorderwid, borderStyle: 'solid'}}>
                    ...
                    <div className="card-body" >
                      <h5 className="card-title" style={{fontFamily: selFontFam ,color:selFontcolor, fontSize: selFontsiz }}>
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ps-3">
                          <h6 style={{ fontFamily: selFontFam }}>$3,264</h6>
                          <span
                            className="text-success small pt-1 fw-bold"
                            style={{ fontFamily: selFontFam }}
                          >
                            8%
                          </span>{" "}
                          <span className="text-muted small pt-2 ps-1">
                ...
                <div className="col-12">
                  <div className="card"  style={{ borderRadius: selBorderrad,borderColor: selBordercolor,borderWidth: selBorderwid, borderStyle: 'solid' }}>
                    ...
                    <div className="card-body"  style={{ borderRadius: selBorderrad }}>
                      <h5 className="card-title" style={{fontFamily: selFontFam ,color:selFontcolor, fontSize: selFontsiz }}>
                ...
                <div className="col-12">
                  <div className="card top-selling overflow-auto"  style={{ borderRadius: selBorderrad,borderColor: selBordercolor,borderWidth: selBorderwid, borderStyle: 'solid' }}>
                    ...
                    <div className="card-body pb-0"  style={{ borderRadius: selBorderrad }}>
                      <h5 className="card-title" style={{fontFamily: selFontFam ,color:selFontcolor, fontSize: selFontsiz }}>
